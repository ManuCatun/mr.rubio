        ...
        try {
            ...
            if (message.guild.members.me.roles.highest.position > usuario.roles.highest.position) {
                ...
                if (message.member.roles.highest.position > usuario.roles.highest.position) {
                    ...
                    return message.reply(`<:nope_normal:1012749750459695114> *| Tu rol está por __debajo__ del usuario que quieres desmutear!*`)
                }
            } else {
                return message.reply(`<:nope_normal:1012749750459695114> *| Mi rol está por __debajo__ del usuario que quieres desmutear!*`)
            }
